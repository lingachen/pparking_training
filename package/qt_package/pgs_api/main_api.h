...
extern "C" int minc_pgs_query_data_blk_by_pageindex(char *pageindex, struct data_blk_rec *out_data_blk_rec);
...
extern "C" int minc_pgs_add_blacklist(struct data_blk_rec *inp_blacklist);
extern "C" int minc_pgs_query_blacklist(struct data_blk_rec *out_blacklist);
...
extern "C" int minc_pgs_init_alarm(int total_lots, time_t *watchdog_time, struct data_pgs_rec *inp_data_pgs_rec);
extern "C" int minc_pgs_update_alarm(bool update_watchdog_timer, char *lotid, char *status_str);
extern "C" int minc_pgs_read_alarm(struct data_alarm_rec *data_alarm);
