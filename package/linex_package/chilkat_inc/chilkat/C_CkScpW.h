...
CK_VISIBLE_PUBLIC void CkScpW_getSendEnv(HCkScpW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkScpW_putSendEnv(HCkScpW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkScpW_sendEnv(HCkScpW cHandle);
