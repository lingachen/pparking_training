...
CK_VISIBLE_PUBLIC void CkScp_getSendEnv(HCkScp cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void CkScp_putSendEnv(HCkScp cHandle, const char *newVal);
CK_VISIBLE_PUBLIC const char *CkScp_sendEnv(HCkScp cHandle);
