...
CK_VISIBLE_PUBLIC void CkEmailW_getUncommonOptions(HCkEmailW cHandle, HCkString retval);
CK_VISIBLE_PUBLIC void  CkEmailW_putUncommonOptions(HCkEmailW cHandle, const wchar_t *newVal);
CK_VISIBLE_PUBLIC const wchar_t *CkEmailW_uncommonOptions(HCkEmailW cHandle);
