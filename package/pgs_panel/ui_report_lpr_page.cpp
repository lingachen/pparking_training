...
ui_report_lpr_page::ui_report_lpr_page(QWidget *parent) : QWidget(parent)
{
    if (this->objectName().isEmpty())
        this->setObjectName(QStringLiteral("ui_report_lpr_page"));
    ...
    info = new QTableWidget(50, header.size());
...
void ui_report_lpr_page::init_data()
{
    header << "Modified_time" << "Station_id" << "Platenum" << "Ptype" << "Movement_time" << "Car_image" << "Comments";
}

void ui_report_lpr_page::btn_search_clicked()
{
...
void ui_report_lpr_page::btn_export_clicked()
{

}

void ui_report_lpr_page::info_record_clicked(int row, int col)
{
